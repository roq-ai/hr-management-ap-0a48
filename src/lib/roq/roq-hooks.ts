...
export function useInterviewFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useInterviewFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.interview.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInterviewCount<T extends Prisma.interviewCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.interviewCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useInterviewCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.interview.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInterviewFindManyWithCount<
  T extends Prisma.interviewFindManyArgs,
  R extends { data: GetFindResult<Prisma.$interviewPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.interviewFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useInterviewFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.interview.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInterviewFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useInterviewFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.interview.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,

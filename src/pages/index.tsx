  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless HR operations with HR Management Application - Your ultimate solution for efficient and effective human resources management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR operations with HR Management Application - Your ultimate solution for efficient and effective human resources management.`}
            </Text>
            <Box

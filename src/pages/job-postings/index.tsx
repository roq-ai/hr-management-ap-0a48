...
export function JobPostingListPage(props: JobPostingListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['title.contains', 'description.contains', 'requirements.contains', 'salary_range.contains'],
          ...params.filters,
        },
        'job_posting',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.closing_date ? format(record?.closing_date, 'dd-MM-yyyy') : '',
    },

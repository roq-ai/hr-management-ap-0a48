...
import { useRoqPlatformUserProfiles, useJobPostingCount, useInterviewCount, useApplicationCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const interviewStat = useInterviewCount();

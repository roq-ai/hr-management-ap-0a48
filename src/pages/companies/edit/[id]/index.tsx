    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="founded_year" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Founded Year
            </FormLabel>
            <DatePicker
              selected={formik.values?.founded_year ? new Date(formik.values?.founded_year) : null}
              onChange={(value: Date) => formik.setFieldValue('founded_year', value)}
            />
          </FormControl>

...
import { useRoqClient, useInterviewFindManyWithCount } from 'lib/roq';
...
export function InterviewListPage(props: InterviewListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: [
            'interviewer.contains',
            'interview_notes.contains',
            'interview_result.contains',
            'next_steps.contains',
          ],
          ...params.filters,
        },
  ...
  const { data, error, isLoading, mutate } = useInterviewFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.interview.delete({ where: { id } });
      await mutate();
    } catch (error) {
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.interview_date ? format(record?.interview_date, 'dd-MM-yyyy') : '',
    },
    { id: 'interviewer', header: 'Interviewer', accessorKey: 'interviewer' },
    { id: 'interview_notes', header: 'Interview Notes', accessorKey: 'interview_notes' },
    { id: 'interview_result', header: 'Interview Result', accessorKey: 'interview_result' },
    { id: 'next_steps', header: 'Next Steps', accessorKey: 'next_steps' },

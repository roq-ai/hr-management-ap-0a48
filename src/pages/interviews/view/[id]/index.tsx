...
function InterviewViewPage() {
  ...
  const queryParams = useMemo<{ include: { application: boolean } }>(
    () =>
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  ...
                  text={data?.interview_date ? format(data?.interview_date, 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Interviewer" text={data?.interviewer} />

                <FormListItem label="Interview Notes" text={data?.interview_notes} />

                <FormListItem label="Interview Result" text={data?.interview_result} />

                <FormListItem label="Next Steps" text={data?.next_steps} />
